    ...
    async def add_bday(self, ctx, message:str):
        ...
        try:
            ...
            if result is True:
                ...
                await self.bot.get_channel(id=Guild1947.EKA_BOT_CHANNEL_ID).send(f"Oh ! We have already recorded your DOB as {str(result)}, Try eka update_bday , If you want to update it.")
            else:
